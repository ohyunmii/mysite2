...
<body>
	<div id="container">
		<div id="header">
			<h1>MySite</h1>
			<ul>
				<li><a href="">로그인</a></li><li>
				</li><li><a href="">회원가입</a></li><li>
				</li><li><a href="">회원정보수정</a></li><li>
				</li><li><a href="">로그아웃</a></li><li>
				</li><li>님 안녕하세요 ^^;</li>
			</ul>
		</div>
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" style ="width:200px"  src="<%=request.getContextPath() %>/assets/images/ruy.JPG">
